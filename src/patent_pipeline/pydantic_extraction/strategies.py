...
def extract_single_metadata(
    ...
    *,
    ...
    prompt = extractor.prompt_template.format(text=text_for_prompt) + suffix
...
def run_two_pass_targeted_strategy(
    extractor: Any,
    ocr_text: str,
    *,
    debug: bool = False,
